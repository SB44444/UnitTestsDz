...
//        System.out.println(calculatingDiscount(-100, 25));
    ...
    /**
     * Функция возведения в степень библиотеки Math
     * @param valueM число, для которого находим степень тип double
     * @param powValueM  показатель степени тип double
     * @return
     */

    public static double powMath(double valueM, double powValueM) {
        return Math.pow(valueM, powValueM);
    }
